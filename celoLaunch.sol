...
contract celoLaunch is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public _routerAddress = 0xf9Be69b55392e89cEA96ba9C90CABF89B3B28092; //cLASwap Router
    ...
    string private _name = "celoLaunch";
    string private _symbol = "cLA";
